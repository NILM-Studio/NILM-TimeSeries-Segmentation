...
data = np.load("./lstm_dbscan/data/data.npy")
seq_len = np.load("./lstm_dbscan/data/seq_length.npy")  
...
result_dir = "./lstm_dbscan/result/"
np.save(f"{result_dir}lstm_extracted_features.npy", X_lstm_extracted_features)
print(f"结果已保存到: {result_dir}lstm_extracted_features.npy")